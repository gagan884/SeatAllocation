...
namespace BAL
{
    public class JEPBNAllocation2022 : ComCouns21Allocation
    {
        public JEPBNAllocation2022() : base()
        {
            // board Id 
            boardId = "134232221";
            ...
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_JEPBN";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_JEPBN";
