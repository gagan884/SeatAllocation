...
namespace BAL
{
    public class MMMUTAllocation2024 : ComCouns21Allocation
    {
        public MMMUTAllocation2024() : base()
        {
            // board Id 
            boardId = "146012421";
                ...
                while ((rdrChoice.Read()))
                {
                    ...
                    if (isValidChoice)
                    {
                        ...
                        foreach (string option in catSubCatOptions.Split(','))
                        {
                            ...
                            foreach (string choiceGender in choiceGenderId.Split(','))
                            {
                                if (choiceGender.Equals("F") && !candGender.Equals("02"))
                                {
                                    continue;
                                }
                                else
                                {
                                    waitListKey = choiceInstCd + "." + choiceBrCd + "." + choiceStreamId + "." + choiceGroupId + "." + choiceSeatTypeId + "." + option + "." + choiceGender;
                                }
