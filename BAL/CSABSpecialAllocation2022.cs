...
namespace BAL
{
    public class CSABSpecialAllocation2022 : AbstractAllocation, IUserInterface
    {
        ...
        protected readonly string DBProc_DereserveSeat = "XApp_Dereserve_CSABSpecial";
        ...
        public CSABSpecialAllocation2022() : base()
        {
        ...
        public override ActionOutput CreateVirtualChoice()
        {
            ...
            foreach (DataRow drCand in dtCand.Rows)
            {
                ...
                if (drCand["Willingness"].ToString() == "RF")
                {
                    ...
                    restrictedOPtNo = (int)SqlHelper.ExecuteDataset(connectionString, CommandType.Text, "select * from Allotment where roundno=" + (roundNo - 1) + " and rollno='" + drCand["Rollno"].ToString() + "'").Tables[0].Rows[0]["optno"];
                }
                else
                    restrictedOPtNo = 0;
