...
namespace BAL
{
    public class CCMTAllocation2022 : AbstractAllocation
    {
        ...
        public CCMTAllocation2022() : base()
        {

            // board Id 
            boardId = "105012221"; /*BoardId changed and refered from app table*/

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat_CCMT";
            ...
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_CCMT";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_CCMT";
            ...
            DBProc_GetSeatRankTypeMapping = "XApp_CC_GetSeatRankTypeMapping_CCMT";
