...
namespace BAL
{
    public class CSABSPecialAllocation : AbstractAllocation
    {
        protected string boardId;
        protected string connectionString;
        public CSABSPecialAllocation() : base()
        {
            //boardId = "134172121";
        ...
        public override ActionOutput PrepareSeat()
        {
            ...
            SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "XApp_PrepareSeat_CSABSpecial", sqlParameters);
        ...
        public override ActionOutput PrepareEligibleCandidate()
        {
            SqlParameter[] sqlParameters = new SqlParameter[1];
            sqlParameters[0] = new SqlParameter("@roundno", roundNo);
            SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "XApp_PrepareEligibleCandidate_CSABSpecial", sqlParameters);
            return new ActionOutput(ActionStatus.Success);
        }
        ...
        public override ActionOutput PreparePreviousAllotment()
        {
            SqlParameter[] sqlParameters = new SqlParameter[1];
            sqlParameters[0] = new SqlParameter("@roundno", roundNo);
            SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "XApp_PreparePreviousAllotment_CSABSpecial", sqlParameters);
            return new ActionOutput(ActionStatus.Success);
        }
        ...
        public override ActionOutput CreateVirtualChoice()
        {
            ...
            DataTable dtHomeInstitute = objSql.GetDataTableUsingCommand("select distinct instcd+hstcd code from HomeInstitute");
            ...
            SqlCommand cmdChoice = new SqlCommand("XApp_GetCandidateChoice_CSABSpecial", connChoice);
            ...
            DataTable dtCand = objSql.GetDataTableUsingCommand("XP_GetEligibleCandidate", CommandType.StoredProcedure);
            ...
            connChoice.Close();
            objSql.ExecuteCommand("truncate table XT_VirtualChoice");
            objSql.SaveTableUsingBulkCopy(ref dtAllChoices, "XT_VirtualChoice", 350);
            return new ActionOutput(ActionStatus.Success);
        }
        ...
        public override bool DereserveSeat(int iterationSeq)
        {
            ...
            connDereserve.Open();
            SqlCommand cmd = new SqlCommand("XApp_Dereserve_CSABSpecial", connDereserve) { CommandType = CommandType.StoredProcedure };
        ...
        public override ActionOutput UpdateApplicationAfterAllocation()
        {
            ...
            connUpdateApp.Open();
            SqlCommand cmd = new SqlCommand("XApp_UpdateApplication_CSABSpecial", connUpdateApp) { CommandType = CommandType.StoredProcedure };
