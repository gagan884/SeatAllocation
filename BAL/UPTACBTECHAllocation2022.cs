...
namespace BAL
{
    public class UPTACBTECHAllocation2022 : ComCouns21Allocation
    {
        public UPTACBTECHAllocation2022() : base()
        {
            // board Id 
            boardId = "130082221";

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat_UPSEEUG";

            //Procedure to prepare Eligible Candidate
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_UPSEEUG";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_UPSEEUG";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_UPSEEUG";
        ...
        public override ActionOutput CreateVirtualChoice()
        {
            ...
            string[] frozenSeats = {"800112.114291T.03.G1.UPTAC.HS.OP.TF.B"};
