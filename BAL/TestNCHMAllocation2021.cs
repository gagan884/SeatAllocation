...
namespace BAL
{
    public class TestNCHMAllocation2021 : ComCouns21Allocation
    {
        public TestNCHMAllocation2021() : base()
        {
            // board Id 
            boardId = "103012121"; /*Change BoardId for current counselling*/

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat";

            //Procedure to prepare Eligible Candidate
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_NCHM";
