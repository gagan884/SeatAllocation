...
namespace BAL
{
    public class UPTACPGAllocation2022 : ComCouns21Allocation
    {
        public UPTACPGAllocation2022() : base()
        {
            // board Id 
            boardId = "130062221";

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat_UPSEEPG";
            ...
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_UPSEEPG";
