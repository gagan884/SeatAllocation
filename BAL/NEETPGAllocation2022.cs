...
namespace BAL
{
    public class NEETPGAllocation2022 : ComCouns21Allocation
    {
        public NEETPGAllocation2022() : base()
        {
            // board Id 
            boardId = "140012221";
            ...
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_NEETPG";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_NEETPG";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_NEETPG";

            //Procedure to update the allotment,allotment summary and other output table
            //after completion of allocation
            DBProc_UpdateApplication = "XApp_CC_UpdateApplication_NEETPG";
            ...
            DBProc_GetCandidateChoice = "XApp_CC_GetCandidateChoice_NEETPG";
            ...
            DBProc_GetCandidateAllChoices = "XApp_CC_GetCandidateChoiceAll";    // XApp_CC_GetCandidateChoice_NEETPG
        }
        ...
        */
        ...
        public override ActionOutput CreateVirtualChoice()
        {
                    ...
                    if (isValidChoice)
                    {
                        ...
                        else
                        {
                            foreach (string option in catSubCatOptions.Split(','))
                            {
                                ...
                                waitListKey = choiceInstCd + "." + choiceBrCd + ".90.G1.NA." + choiceQuotaId + "." + option + ".B";
            ...
            return new ActionOutput(ActionStatus.Success, "Completed:Choice created for" + dtAllChoices.Rows.Count + " candidates");
            ***********************************************/
            return new ActionOutput(ActionStatus.Success, "Completed:Choice created for" + "xyz"+ " candidates");
        }
