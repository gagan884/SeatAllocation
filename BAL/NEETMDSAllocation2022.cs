...
namespace BAL
{
    public class NEETMDSAllocation2022 : ComCouns21Allocation
    {
        public NEETMDSAllocation2022() : base()
        {
            // board Id 
            boardId = "140022221";
            ...
            DBProc_GetCandidateAllChoices = "XApp_CC_GetCandidateChoiceAll_NEETMDS";
        }
        ...
        public override ActionOutput CreateVirtualChoice()
        {
            ...
            foreach (DataRow drCand in dtCand.Rows)
            {
                ...
                if (candRollNo == "2055207091" || candRollNo == "2055208286" || candRollNo == "2055219937")
                {
                    ;
                }
