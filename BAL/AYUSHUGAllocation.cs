...
namespace BAL
{
    public class AYUSHUGAllocation : ComCouns21Allocation
    {
        public AYUSHUGAllocation() : base()
        {
            // board Id 
            boardId = "141012121";
            ...
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_AYUSHUG";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_AYUSHUG";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_AYUSHUG";

            //Procedure to update the allotment,allotment summary and other output table
            //after completion of allocation
            DBProc_UpdateApplication = "XApp_CC_UpdateApplication_AYUSHUG";
            ...
            DBProc_GetCandidateChoice = "XApp_CC_GetCandidateChoice_AYUSHUG";
