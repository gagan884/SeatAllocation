...
namespace BAL
{
    public class NIMCETAllocation2022 : ComCouns21Allocation
    {
        public NIMCETAllocation2022() : base()
        {
            // board Id 
            boardId = "144012221";
            ...
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_NIMCET";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_NIMCET";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_NIMCET";
