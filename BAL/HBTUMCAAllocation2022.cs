...
namespace BAL
{
    public class HBTUMCAAllocation2022 : ComCouns21Allocation
    {
        public HBTUMCAAllocation2022() : base()
        {
            // board Id 
            boardId = "131022221";

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat_HBTUMCA";

            //Procedure to prepare Eligible Candidate
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_HBTUMCA";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_HBTUMCA";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_HBTUMCA";
