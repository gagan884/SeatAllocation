...
namespace BAL
{
    public class NCHMMSCAllocation2022 : ComCouns21Allocation
    {
        public NCHMMSCAllocation2022() : base()
        {
            // board Id 
            boardId = "103022221"; /*Change BoardId for current counselling*/

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat";

            //Procedure to prepare Eligible Candidate
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_NCHMMSC";
