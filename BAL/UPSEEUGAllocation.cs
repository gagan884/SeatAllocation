...
namespace BAL
{
    public class UPSEEPGAllocation : ComCouns21Allocation
    {
        public UPSEEPGAllocation() : base()
        {
            boardId = "130062121";
        }
        public override ActionOutput PrepareEligibleCandidate()
        {
            ...
            SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "XApp_CC_PrepareEligibleCandidate_UPSEEPG", sqlParameters);
        ...
        public override ActionOutput PrepareSeat()
        {
            ...
            sqlParameters[0] = new SqlParameter("@" + DBParam_BoardId, boardId);
            sqlParameters[1] = new SqlParameter("@" + DBParam_RoundNo, roundNo);
            SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "XApp_CC_PrepareSeat_UPSEEPG", sqlParameters);
        ...
        public override ActionOutput PreparePreviousAllotment()
        {
            ...
            sqlParameters[0] = new SqlParameter("@" + DBParam_BoardId, boardId);
            sqlParameters[1] = new SqlParameter("@" + DBParam_RoundNo, roundNo);
            SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "XApp_CC_PreparePreviousAllotment_UPSEEPG", sqlParameters);
