...
namespace BAL
{
    public class IIMCAllocation2022 : ComCouns21Allocation
    {
        public IIMCAllocation2022() : base()
        {
            // board Id 
            boardId = "145012221";
        ...
        protected override string GetAllotmentSequence(string rollno, string category, string subcategoryList, string gender, string domicile, string additionalInfo, string symbolList, string rankData)
        {
            ...
            if (category == "GN" && subcategoryList.Contains("PH:YES"))
            {
                catSubCatOptions.Append("NO.PH,");
            }
