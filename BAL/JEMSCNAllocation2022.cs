...
namespace BAL
{
    public class JEMSCNAllocation2022 : ComCouns21Allocation
    {
        public JEMSCNAllocation2022() : base()
        {
            // board Id 
            boardId = "134192221";
            ...
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_JEMSCN";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_JEMSCN";
        ...
        protected override string GetAllotmentSequence(string rollno, string category, string subcategoryList, string gender, string domicile, string additionalInfo, string symbolList, string rankData)
        {
            ...
            if (subcategoryList.Contains("PH:YES") && domicile.Equals("35"))
            {
            ...
            if (category != "GN")
            {
                if ("BA.BB".Contains(category))
                {
                    catSubCatOptions.Append("AI.BC.NO,");
                }
                else
                {
