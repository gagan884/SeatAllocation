...
namespace BAL
{
    public class APJEEAllocation2022 : ComCouns21Allocation
    {
        public APJEEAllocation2022() : base()
        {
            // board Id 
            boardId = "110022221"; /*Change BoardId for current counselling*/

            //Procedure to prepare seat
            DBProc_PrepareSeat = "XApp_CC_PrepareSeat";

            //Procedure to prepare Eligible Candidate
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_APJEE";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_APJEE";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_APJEE";
