...
namespace BAL
{
    public class MCCPGAllocation : ComCouns21Allocation
    {
        public MCCPGAllocation() : base()
        {
            // board Id 
            boardId = "140012121";
            ...
            DBProc_PrepareEligibleCandidate = "XApp_CC_PrepareEligibleCandidate_NEETMDS";

            //Procedure to prepare Previous allotment or seat gaurnatee candidates
            DBProc_PreparePreviousAllotment = "XApp_CC_PreparePreviousAllotment_NEETMDS";

            //Procedure to dereserve seats
            DBProc_DereserveSeat = "XApp_CC_DereserveSeat_NEETMDS";

            //Procedure to update the allotment,allotment summary and other output table
            //after completion of allocation
            DBProc_UpdateApplication = "XApp_CC_UpdateApplication_NEETMDS";
            ...
            DBProc_GetCandidateChoice = "XApp_CC_GetCandidateChoice_NEETMDS";
